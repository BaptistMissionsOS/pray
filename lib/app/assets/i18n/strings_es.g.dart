...
// Path: titles
class _TranslationsTitlesEs implements TranslationsTitlesEn {
	_TranslationsTitlesEs._(this._root);
...
// Path: content
class _TranslationsContentEs implements TranslationsContentEn {
	_TranslationsContentEs._(this._root);
...
class _TranslationsDrawerCategoriesEs implements TranslationsDrawerCategoriesEn {
	_TranslationsDrawerCategoriesEs._(this._root);
...
// Path: drawer.actions
class _TranslationsDrawerActionsEs implements TranslationsDrawerActionsEn {
	_TranslationsDrawerActionsEs._(this._root);
