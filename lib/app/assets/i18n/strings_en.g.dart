...
class Translations with BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsTitlesEn titles = TranslationsTitlesEn._(_root);
	late final TranslationsContentEn content = TranslationsContentEn._(_root);
}
...
class TranslationsDrawerEn {
	...
	late final TranslationsDrawerCategoriesEn categories = TranslationsDrawerCategoriesEn._(_root);
	late final TranslationsDrawerActionsEn actions = TranslationsDrawerActionsEn._(_root);
}
...
class TranslationsTitlesEn {
	TranslationsTitlesEn._(this._root);
...
class TranslationsContentEn {
	TranslationsContentEn._(this._root);
...
class TranslationsDrawerCategoriesEn {
	TranslationsDrawerCategoriesEn._(this._root);
...
class TranslationsDrawerActionsEn {
	TranslationsDrawerActionsEn._(this._root);
